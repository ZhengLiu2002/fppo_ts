...
class ParkourRslRlBaseCfg:
    # Privileged explicit states are split into hurdle semantics (not estimable from proprioception)
    # and other explicit physical states (estimable).
    num_priv_hurdles: int = 8  # 4 hurdle heights + 4 hurdle modes
