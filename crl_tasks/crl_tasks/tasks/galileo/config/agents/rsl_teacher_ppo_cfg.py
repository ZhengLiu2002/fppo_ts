...
_TEACHER_ACTOR_OBS, _TEACHER_CRITIC_OBS = _obs_cfg_for("teacher")
...
class GalileoCRLTeacherPPORunnerCfg(CRLRslRlOnPolicyRunnerCfg):
    ...
    policy = CRLRslRlPpoActorCriticCfg(
        init_noise_std=1.0,
        num_prop=_TEACHER_ACTOR_OBS["num_prop"],
        num_scan=_TEACHER_ACTOR_OBS["num_scan"],
        num_priv_explicit=_TEACHER_ACTOR_OBS["num_priv_explicit"],
        num_priv_latent=_TEACHER_ACTOR_OBS["num_priv_latent"],
        num_hist=_TEACHER_ACTOR_OBS["num_hist"],
        encode_scan_for_critic=(_TEACHER_CRITIC_OBS["critic_num_scan"] > 0),
        critic_num_prop=_TEACHER_CRITIC_OBS["critic_num_prop"],
        critic_num_scan=_TEACHER_CRITIC_OBS["critic_num_scan"],
        critic_num_priv_explicit=_TEACHER_CRITIC_OBS["critic_num_priv_explicit"],
        critic_num_priv_latent=_TEACHER_CRITIC_OBS["critic_num_priv_latent"],
        critic_num_hist=_TEACHER_CRITIC_OBS["critic_num_hist"],
        critic_scan_encoder_dims=[128, 64, 32]
        if _TEACHER_CRITIC_OBS["critic_num_scan"] > 0
        else None,
