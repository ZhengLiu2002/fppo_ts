...
from .crl_manager_term_cfg import CRLTermCfg

if TYPE_CHECKING:
    from crl_isaaclab.envs import CRLManagerBasedRLEnv

"""
CRL Manager is dealing with goal heading position
...
class CRLManager(CommandManager):
    ...
    def _prepare_terms(self):
        ...
        for term_name, term_cfg in cfg_items:
            ...
            if not isinstance(term_cfg, CRLTermCfg):
                raise TypeError(
                    f"Configuration for the term '{term_name}' is not of type CRLTermCfg."
