...
if TYPE_CHECKING:
    from ..terrains import CRLSubTerrainBaseCfg


def crl_field_to_mesh(func: Callable) -> Callable:
    @functools.wraps(func)
    def wrapper(difficulty: float, cfg: CRLSubTerrainBaseCfg, num_goals: int):
