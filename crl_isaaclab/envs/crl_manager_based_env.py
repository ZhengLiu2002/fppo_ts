...
from .crl_manager_based_env_cfg import CRLManagerBasedEnvCfg
...
class CRLManagerBasedEnv(ManagerBasedEnv):
    def __init__(self, cfg: CRLManagerBasedEnvCfg):
        ...
        if self.sim.render_mode >= self.sim.RenderMode.PARTIAL_RENDERING:
            self.viewport_camera_controller = CRLViewportCameraController(self, self.cfg.viewer)
        else:
    ...
    def load_managers(self):
        ...
        if self.__class__ == CRLManagerBasedEnv and "startup" in self.event_manager.available_modes:
