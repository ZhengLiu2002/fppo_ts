...
from .crl_manager_based_rl_env_cfg import CRLManagerBasedRLEnvCfg
...
class CRLManagerBasedRLEnv(CRLManagerBasedEnv, gym.Env):
    ...
    cfg: CRLManagerBasedRLEnvCfg

    def __init__(self, cfg: CRLManagerBasedRLEnvCfg, render_mode: str | None = None, **kwargs):
    ...
    def load_managers(self):
        ...
        # -- reward manager
        self.reward_manager = CRLRewardManager(self.cfg.rewards, self)
    ...
    def _reset_idx(self, env_ids: Sequence[int]):
        ...
        if self.crl_manager is not None:
            info = self.crl_manager.reset(env_ids)
            ...
            if cost_info:
                for key, value in cost_info.items():
                    if key.startswith("Episode_Reward/"):
                        ...
                        self.extras["log"]["Episode_Cost/" + key] = value
        # -- curriculum manager
