...
class CRLManagerBasedRLEnvWindow(BaseEnvWindow):
    ...
    def __init__(self, env: CRLManagerBasedEnv, window_name: str = "IsaacLab"):
        ...
        with self.ui_window_elements["main_vstack"]:
            with self.ui_window_elements["debug_frame"]:
                with self.ui_window_elements["debug_vstack"]:
                    ...
                    if getattr(env, "crl_manager", None) is not None:
                        self._visualize_manager(title="CRL", class_name="crl_manager")
